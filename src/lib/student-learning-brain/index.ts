...
export function toStudentDashboardBrainView(
  ...
  return {
    ...
    orchestrationSummary: brain.academicIntelligence.orchestration,
    coachTutorAuditSummary: brain.academicIntelligence.coachTutorAudit,
...
export function toParentLearningBrainView(brain: StudentLearningBrain) {
  return {
    ...
    quickLevelFinderBaseline: brain.quickLevelFinderBaseline,
    heartbeatSummary: brain.heartbeatSummary,
    orchestration: brain.studentSafeAcademicIntelligence.orchestration,
    coachTutorAudit: brain.studentSafeAcademicIntelligence.coachTutorAudit,
...
export function toAdminLearningBrainView(brain: StudentLearningBrain) {
  return {
    ...
    quickLevelFinderBaseline: brain.quickLevelFinderBaseline,
    heartbeatSummary: brain.heartbeatSummary,
    orchestration: brain.academicIntelligence.orchestration,
