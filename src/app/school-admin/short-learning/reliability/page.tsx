  ...
  return (
    <div className="mx-auto max-w-5xl p-6 lg:p-10">
      ...
      {loading ? (
        ...
        <>
          <CollapsibleCard title="Reliability summary" className="mt-6" bodyClassName="grid gap-4 p-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <p className="mt-2 text-xs text-foreground/50 sm:col-span-2 lg:col-span-4">
          ...
          {restrictedParents.length > 0 ? (
            <CollapsibleCard title="Restricted parents summary" className="mt-8 overflow-hidden border-amber-200 bg-amber-50/50">
          ...
          <CollapsibleCard title="All parents with bookings" className="mt-8" count={reliability.parents.length}>
            {reliability.parents.length === 0 ? (
              <p className="p-4 text-sm text-foreground/60">No booking history in lookback window.</p>
            ) : (
              <>
                <table className="w-full text-sm">
