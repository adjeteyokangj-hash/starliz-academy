    ...
    >
      ...
      <div className="grid gap-3 lg:grid-cols-2">
        ...
        <article className="rounded-xl border border-slate-700/70 bg-slate-950/60 p-4">
          ...
          <Link href={`/admin/schools/${schoolId}/billing-licence`} className="mt-3 inline-flex rounded-lg border border-slate-600 bg-slate-900 px-3 py-1.5 text-xs font-semibold text-slate-200 transition hover:border-slate-500 hover:text-white">Manage Licence</Link>
        </article>
      </div>
