...
const updateSchema = z.object({
  ...
  easierWords: z.union([z.string(), z.array(z.string())]).optional().nullable(),
  harderWords: z.union([z.string(), z.array(z.string())]).optional().nullable(),
  prerequisiteWords: z.union([z.string(), z.array(z.string())]).optional().nullable(),
  relatedMathConcepts: z.union([z.string(), z.array(z.string())]).optional().nullable(),
  phonicsFamilies: z.union([z.string(), z.array(z.string())]).optional().nullable(),
  spellingFamilies: z.union([z.string(), z.array(z.string())]).optional().nullable(),
  curriculumTopics: z.union([z.string(), z.array(z.string())]).optional().nullable(),
  interventionPaths: z.union([z.string(), z.array(z.string())]).optional().nullable(),
